...
class LeilaoTest extends TestCase
{
    ...
    public function geraLances()
    {
        ...
        $leilaoCom2Lances = new Leilao(descricao: 'Fiat 147 0KM');
        $leilaoCom2Lances->recebeLance(new Lance($joao, valor: 1000));
        $leilaoCom2Lances->recebeLance(new Lance($maria, valor: 2000));
